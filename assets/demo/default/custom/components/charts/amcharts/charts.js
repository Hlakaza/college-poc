var amChartsChartsDemo = (function() {
  var e = function() {
      AmCharts.makeChart("m_amcharts_1", {
        ...
        theme: "light",
        dataProvider: [
          { country: "Botshelong Hospital", visits: 2025 },
          { country: "Memorial Hospital", visits: 1882 },
          { country: "Victoria Itokolle Hospital", visits: 1809 },
          { country: "Themba Hospital", visits: 1866 },
          { country: "Nkanyezi HospitalUK", visits: 1800 },
          { country: "Morewa Memorial Hospital", visits: 2000 }
        ],
    ...
    n = function() {
      AmCharts.makeChart("m_amcharts_9", {
        ...
        valueAxes: [{ axisTitleOffset: 20, minimum: 0, axisAlpha: 0.15 }],
        startDuration: 2,
        graphs: [
          {
